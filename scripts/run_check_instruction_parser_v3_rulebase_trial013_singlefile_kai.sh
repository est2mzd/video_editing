...
PARSER_FILE="${PARSER_FILE:-$ROOT/src/parse/instruction_parser_v3_rulebase_trial013_singlefile_kai.py}"
VALIDATOR_FILE="${VALIDATOR_FILE:-$ROOT/src/parse/validate_rulebase_single_trial.py}"
TRIAL_NAME="${TRIAL_NAME:-trial_rulebase_013_singlefile_kai_check}"
...
echo "[INFO] Running rulebase trial013 singlefile kai check" | tee "$LOG_FILE"
