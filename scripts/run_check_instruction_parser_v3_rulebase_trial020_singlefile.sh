...
PARSER_FILE="${PARSER_FILE:-$ROOT/src/parse/instruction_parser_v3_rulebase_trial020_singlefile.py}"
VALIDATOR_FILE="${VALIDATOR_FILE:-$ROOT/src/parse/validate_rulebase_single_trial.py}"
TRIAL_NAME="${TRIAL_NAME:-trial_rulebase_020_singlefile_check}"
...
echo "[INFO] Running rulebase trial020 singlefile check" | tee "$LOG_FILE"
