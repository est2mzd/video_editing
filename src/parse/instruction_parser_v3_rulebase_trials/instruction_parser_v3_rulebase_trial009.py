#!/usr/bin/env python3
"""Trial 009 based on v3.

Single countermeasure:
- Prioritize add_object signals before style-related cues.
"""
...
from parse.prototype_instruction_parser_v3_improved_trials.prototype_instruction_parser_v3_improved_trial008 import (
    InstructionParserV3Trial008,
)
...
class InstructionParserV3Trial009(InstructionParserV3Trial008):
...
def build_parser() -> InstructionParserV3Trial009:
    kb = build_knowledge_db_v3(GT_PATH)
    return InstructionParserV3Trial009(kb)
