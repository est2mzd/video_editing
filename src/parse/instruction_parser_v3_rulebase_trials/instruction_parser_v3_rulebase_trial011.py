#!/usr/bin/env python3
"""Trial 011 based on v3.

Single countermeasure:
- High-impact action boundary fixes for misrouted classes.
"""
...
from parse.prototype_instruction_parser_v3_improved_trials.prototype_instruction_parser_v3_improved_trial010 import (
    InstructionParserV3Trial010,
)
...
class InstructionParserV3Trial011(InstructionParserV3Trial010):
...
def build_parser() -> InstructionParserV3Trial011:
    kb = build_knowledge_db_v3(GT_PATH)
    return InstructionParserV3Trial011(kb)
