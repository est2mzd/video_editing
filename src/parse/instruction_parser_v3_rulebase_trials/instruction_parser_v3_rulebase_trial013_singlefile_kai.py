#!/usr/bin/env python3
"""Trial013 single-file reproduction (kai).

Goal:
- Reproduce high-accuracy Trial013 behavior in one file.
- No import from other parser trial files.
"""
...
class InstructionParserV3RulebaseTrial013SinglefileKai:
...
def build_parser() -> InstructionParserV3RulebaseTrial013SinglefileKai:
    kb = build_knowledge_db_v3(GT_PATH)
    return InstructionParserV3RulebaseTrial013SinglefileKai(kb)


if __name__ == "__main__":
    p = build_parser()
    print(p.pred("Increase the amount of red fruit jam on the white plate."))
