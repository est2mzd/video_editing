...
class InstructionParserV3MixedTrial001:
...
def build_parser() -> InstructionParserV3MixedTrial001:
    return InstructionParserV3MixedTrial001(LLMConfig())
