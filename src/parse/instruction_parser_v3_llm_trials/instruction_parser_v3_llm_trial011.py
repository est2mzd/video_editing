#!/usr/bin/env python3
"""LLM trial 011 parser (LLM-first, no singlefile import).
...
class InstructionParserV3LLMTrial011:
...
def build_parser() -> InstructionParserV3LLMTrial011:
    return InstructionParserV3LLMTrial011(LLMConfig())
