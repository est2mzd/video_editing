#!/usr/bin/env python3
"""LLM trial 008 parser (LLM-first, no singlefile import).
...
class InstructionParserV3LLMTrial008:
...
def build_parser() -> InstructionParserV3LLMTrial008:
    return InstructionParserV3LLMTrial008(LLMConfig())
