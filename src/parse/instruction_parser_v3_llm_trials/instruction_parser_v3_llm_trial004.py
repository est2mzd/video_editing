#!/usr/bin/env python3
"""LLM trial 004 parser (LLM-first, no singlefile import).
...
class InstructionParserV3LLMTrial004:
...
def build_parser() -> InstructionParserV3LLMTrial004:
    return InstructionParserV3LLMTrial004(LLMConfig())
