#!/usr/bin/env python3
"""LLM trial 012 parser (LLM-first, no singlefile import).
...
class InstructionParserV3LLMTrial012:
...
def build_parser() -> InstructionParserV3LLMTrial012:
    return InstructionParserV3LLMTrial012(LLMConfig())
