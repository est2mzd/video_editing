#!/usr/bin/env python3
"""LLM trial 013 parser (LLM-first, no singlefile import).
...
class InstructionParserV3LLMTrial013:
...
def build_parser() -> InstructionParserV3LLMTrial013:
    return InstructionParserV3LLMTrial013(LLMConfig())
